  ...
  return (
    <>
      ...
      <Suspense fallback={<RouteFallback />}>
        <Routes>
          {/* Public: landing and the conversion-focused CDMO page. */}
          ...
          {/* Admin only: internal analytics and data tooling, plus the
              retrosynthesis explorer (now an internal analyst tool). */}
      ...
      {/* Floating assistant, persistent across navigation on public pages. */}
      <ChatWidget />
    </>
  );
}
